...
- [ ] 장바구니 목록 요청 API 기능
- [ ] 로그인한 회원의 서버에 저장된 장바구니 목록을 반환하는 기능
    - [ ] cart_item table
    - [ ] id, 상품 아이디(productId), 상품명(name), 상품 이미지(image), 상품 가격(price), 장바구니에 담긴 갯수(quantity)
- [ ] JSON 배열 형식으로 아이템을 응답한다
- [ ] 액세스 토큰을 통한 유저 정보 확인 필요
- [ ] 중복된 상품 요청 시 갯수를 추가

**장바구니 추가 요청 기능**

- [ ] 장바구니 추가 요청 API 기능
- [ ] 상품 목록의 상품을 장바구니에 추가하는 기능
    - [ ] cart_item table
    - [ ] 상품 아이디(productId), 추가할 수량(quantity)
...
- [ ] 장바구니 정보 수정 API 기능
- [ ] 장바구니에 담긴 아이템의 정보(갯수)를 수정하는 기능
    - [ ] 상품 아이디(productId), 변경할 정보...

**장바구니 아이템 제거 기능**

- [ ] 장바구니 아이템 제거 API 기능
- [ ] 장바구니에 담긴 아이템들을 제거하는 기능
    - [ ] 삭제할 장바구니 아이디 리스트
- [ ] 제거에 성공한 아이디 목록을 응답하는 기능
- [ ] 삭제 시 유저 자신의 장바구니 상품만 제거할 수 있어야 함

**상품 주문하기 기능(미구현)**

- [ ] 상품 주문하기 API 기능
- [ ] 주문할 상품들을 주문하는 기능
    - [ ] 상품 아이디(productId), 주문 수량(quantity)
- [ ] 주문에 성공했다면, 장바구니에서 상품 목록을 제거
...
- [ ] 서버 DB 연결하기
- [ ] cart_item 안에 개수 요소 추가되지 않는 이유 듣기
