...
public class Home_페이지_테스트 {
    ...
    public void 상품_추가_수정_삭제_테스트() throws JsonProcessingException {
        ...
        XmlPath Home_페이지_정보 = 페이지_정보_가져오기("/");
        assertAll(
                () -> assertThat(첫번째_상품의_이름_from(Home_페이지_정보)).isEqualTo("사과즙"),
                () -> assertThat(첫번째_상품의_가격_from(Home_페이지_정보)).isEqualTo("1000"),
                () -> assertThat(두번째_상품의_이름_from(Home_페이지_정보)).isEqualTo("포도")
        );
    }
    ...
    private String 첫번째_상품의_이름_from(XmlPath Admin_페이지_정보) {
        return Admin_페이지_정보.getString("html.body.div"
