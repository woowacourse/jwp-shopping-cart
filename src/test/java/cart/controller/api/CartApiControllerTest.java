...
class CartApiControllerTest {
    ...
    void addProductToCart_invalidProduct() throws Exception {
        // given
        long productId = 1L;
        given(productDao.existsById(productId))
                .willReturn(false);
    ...
    void findAllCartProducts_success() throws Exception {
        ...
        mockMvc.perform(get("/api/cart")
                ...
                .andExpect(jsonPath("$.result[0].cartId").value(1))
                .andExpect(jsonPath("$.result[0].product.productId").value(1))
                ...
                .andExpect(jsonPath("$.result[1].cartId").value(2))
                .andExpect(jsonPath("$.result[1].product.productId").value(1))
                ...
                .andExpect(jsonPath("$.result[2].cartId").value(3))
                .andExpect(jsonPath("$.result[2].product.productId").value(2))
