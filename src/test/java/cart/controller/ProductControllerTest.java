...
class ProductControllerTest {
    ...
    @Test
    @DisplayName("/products 로 요청을 보내 상품을 추가하는 경우, Status Created 를 반환")
    void addProduct() {
    ...
    @Test
    @DisplayName("/products 로 요청을 보내 상품을 추가하는 경우, price 가 양수가 아닌 경우에 Bad Request 반환")
    ...
    @Test
    @DisplayName("/products 로 요청을 보내 상품을 추가하는 경우, imageUrl 과 name 이 null 인 경우 Bad Request 반환")
    ...
    @Test
    @DisplayName("/products/{id} 로 요청을 보내 상품을 수정하는 경우, Status Ok 를 반환")
    void modifyProduct() {
    ...
    @Test
    @DisplayName("/products/{id} 로 요청을 보내 상품을 수정하는 경우, price 가 양수가 아닌 경우에 Bad Request 반환")
    ...
    @Test
    @DisplayName("/products/{id} 로 요청을 보내 상품을 수정하는 경우, imageUrl 과 name 이 null 인 경우 Bad Request 반환")
    ...
    @Test
    @DisplayName("/products/{id} 로 요청을 보내 상품을 삭제하는 경우, Status noContent 를 반환")
    void removeProduct() {
        RestAssured.given().log().all()
                .accept(MediaType.TEXT_HTML_VALUE)
