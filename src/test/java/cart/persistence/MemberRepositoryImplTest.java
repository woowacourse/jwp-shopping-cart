...
@JdbcTest
@ContextConfiguration(classes = MemberRepositoryImpl.class)
class MemberRepositoryImplTest {
    ...
    void findByEmailAndPasswordTest() {
        ...
        Member found1 = memberRepository.findByEmailAndPassword(loginDto1).get();
        Member found2 = memberRepository.findByEmailAndPassword(loginDto2).get();
