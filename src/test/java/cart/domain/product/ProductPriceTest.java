...
class ProductPriceTest {
    ...
    void createProductPriceFailureUnderMinimumPrice(final int input) {
        assertThatThrownBy(() -> ProductPrice.from(input))
                .isInstanceOf(IllegalArgumentException.class);
    }
}
