...
class ProductTest {
    ...
    @Test
    void 상품이_정상_생성된다() {
        assertDoesNotThrow(() -> new ProductEntity("치킨", 1_000, "치킨사진"));
    }
    ...
    void 상품_이름이_50자를_넘기면_예외를_던진다() {
        ...
        // expect
        assertThatThrownBy(() -> new ProductEntity(nameOver50, 10_000, "치킨사진"))
    ...
    void 가격이_0미만_10억초과이면_예외를_던진다(final int price) {
        // expect
        assertThatThrownBy(() -> new ProductEntity("치킨", price, "치킨사진"))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void 이미지_주소가_2_000자_초과하면_예외를_던진다() {
        ...
        // expect
        assertThatThrownBy(() -> new ProductEntity("치킨", 10_000, imageOver2000))
                .isInstanceOf(IllegalArgumentException.class)
