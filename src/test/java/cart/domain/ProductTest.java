    ...
    class Validate {
        ...
        class PriceRange {
            ...
            void negative(final int price) {
                assertThatThrownBy(() -> new Product(1L, "헤나", price, "이미지-url"))
                        .isInstanceOf(IllegalArgumentException.class);
            }
            ...
            void positiveOrZero(final int price) {
                assertDoesNotThrow(() -> new Product(1L, "헤나", price, "이미지-url"));
            }
        }
        ...
        class Image {
            ...
            @Test
            void isNull() {
                assertThatThrownBy(() -> new Product(1L, "헤나", 10000, null))
                        .isInstanceOf(IllegalArgumentException.class);
            }
            ...
            void isString(final String imageUrl) {
                assertDoesNotThrow(() -> new Product(1L, "헤나", 10000, imageUrl));
            }
        }
    }
}
