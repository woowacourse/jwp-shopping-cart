...
public class MemberApiIntegrationTest {
    ...
    void post() throws JsonProcessingException {
        ...
        given()
                .contentType(ContentType.JSON).body(toJson(NO_ID_MEMBER1))
                .log().all()
        .when()
                .post("/members")
        .then()
                ...
                .header(HttpHeaders.LOCATION, "/members/" + memberId);

        assertThat(memberDao.findById(memberId).get().getEmail()).isEqualTo(NO_ID_MEMBER1.getEmail());
    }
