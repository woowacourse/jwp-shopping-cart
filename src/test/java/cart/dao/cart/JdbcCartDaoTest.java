...
class JdbcCartDaoTest {
    ...
    void findAll() {
        Optional<List<CartEntity>> carts = cartDao.findAll("test@naver.com");
        List<CartEntity> retrievedCart = carts.get();
        Assertions.assertThat(retrievedCart).hasSize(2);
    }
    ...
    void delete() {
        ...
        Optional<List<CartEntity>> carts = cartDao.findAll("test@naver.com");
        List<CartEntity> retrievedCart = carts.get();
        Assertions.assertThat(retrievedCart).hasSize(1);
    }
}
