...
//                .andExpect(jsonPath("orderDetails[0].image").value("image"))
...
//                        new OrderDetail(1L, 1_000, "banana", "image", 2))),
//                new Orders(2L, Collections.singletonList(
//                        new OrderDetail(2L, 2_000, "apple", "image2", 4)))
//        );
//
...
//                .andExpect(jsonPath("$[0].orderDetails[0].image").value("image"))
...
//                .andExpect(jsonPath("$[1].orderDetails[0].image").value("image2"))
