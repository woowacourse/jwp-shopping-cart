...
public class CartAcceptanceTest extends AcceptanceTest {
    ...
    void 존재하는_고객의_장바구니를_조회하는_경우() {
        ...
        assertAll(() -> assertThat(cartResponseElements.get(0).getId()).isEqualTo(1L),
                ...
                () -> assertThat(cartResponseElements.get(1).getId()).isEqualTo(3L),
                ...
                () -> assertThat(cartResponseElements.get(2).getId()).isEqualTo(5L),
    ...
    void 사용자의_장바구니에_존재하지_않는_상품을_담는_경우() {
        ...
        assertAll(() -> assertThat(cartResponseElements.get(0).getId()).isEqualTo(1L),
                ...
                () -> assertThat(cartResponseElements.get(3).getId()).isEqualTo(2L),
