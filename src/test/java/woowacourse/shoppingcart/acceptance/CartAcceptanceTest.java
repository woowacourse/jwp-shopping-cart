...
public class CartAcceptanceTest extends AcceptanceTest {
    ...
    public static TokenResponse 로그인_후_토큰_반환() {
        LoginRequest loginRequest = new LoginRequest("puterism@gmail.com", "12345678aA!");
        return 로그인_요청(loginRequest).as(TokenResponse.class);
    }
