...
public class ProductAcceptanceTest extends AcceptanceTest {
    ...
    public static ExtractableResponse<Response> 상품_등록_요청(String name, int price, String imageUrl) {
        ...
        return RestAssuredConvenienceMethod.postRequest(request, "/api/products")
                .extract();
    }

    public static ExtractableResponse<Response> 상품_목록_조회_요청() {
        return RestAssuredConvenienceMethod.getRequest("/api/products")
                .extract();
    }

    public static ExtractableResponse<Response> 상품_조회_요청(Long productId) {
        return RestAssuredConvenienceMethod.getRequest("/api/products/" + productId)
                .extract();
    }

    public static ExtractableResponse<Response> 상품_삭제_요청(Long productId) {
        return RestAssuredConvenienceMethod.deleteRequest("/api/products/" + productId)
                .extract();
    }
