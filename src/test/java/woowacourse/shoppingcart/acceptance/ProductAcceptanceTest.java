...
public class ProductAcceptanceTest extends AcceptanceTest {
    ...
    @Test
    void getProduct() {
        Long productId = 상품_등록되어_있음("치킨", 10_000, "http://example.com/chicken.jpg", "description");
    ...
    public static ExtractableResponse<Response> 상품_등록_요청(String name, int price, String imageUrl, String description) {
    ...
    public static Long 상품_등록되어_있음(String name, int price, String imageUrl, String description) {
        ExtractableResponse<Response> response = 상품_등록_요청(name, price, imageUrl, description);
