...
public class CustomerDaoTest {
    ...
    void findIdByEmailAndPassword() {
        ...
        Long responseId = customerDao.findIdByEmailAndPassword("email", Password.encrypt("Pw123456!").getPassword())
                .get();
    ...
    void findCustomerById() {
        ...
        assertThat(response).extracting("email", "password", "name", "phone", "address")
                .containsExactly("email", Password.encrypt("Pw123456!").getPassword(), "name", "010-1234-5678",
                        "address");
    }
    ...
    void updateCustomer() {
        ...
        assertThat(actual).extracting("email", "password", "name", "phone", "address")
                .containsExactly("email", Password.encrypt("Pw123456!!").getPassword(), "name2", "010-1234-1234",
                        "address2");
    }
