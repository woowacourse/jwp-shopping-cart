...
public class CartItemDaoTest {
    ...
    void setUp() {
        ...
        jdbcTemplate.update("INSERT INTO cart_item(account_id, product_id) VALUES(?, ?)", 1L, 1L);
        jdbcTemplate.update("INSERT INTO cart_item(account_id, product_id) VALUES(?, ?)", 1L, 2L);
    }
