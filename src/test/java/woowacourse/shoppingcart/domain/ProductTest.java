...
public class ProductTest {
    ...
    void 상품_이름이_null인_경우() {
        assertThatThrownBy(() -> new Product(null, 1, "https://www.naver.com"))
                .isInstanceOf(InvalidInformationException.class)
                .hasMessage("[ERROR] 상품 이름은 null이 될 수 없습니다.");
    }

    @Test
    void 상품_이름이_빈칸인_경우() {
        assertThatThrownBy(() -> new Product("", 1, "https://www.naver.com"))
                .isInstanceOf(InvalidInformationException.class)
    ...
    void 상품_이름이_공백으로_시작하거나_끝나는_경우(String invalidName) {
        assertThatThrownBy(() -> new Product(invalidName, 1, "https://www.naver.com"))
                .isInstanceOf(InvalidInformationException.class)
