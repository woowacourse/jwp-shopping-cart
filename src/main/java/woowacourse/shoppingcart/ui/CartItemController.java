...
public class CartItemController {
    ...
    @PostMapping
    public ResponseEntity<Void> addCartItem(@Validated(Request.id.class) @RequestBody final ProductRequest productRequest,
                                      @PathVariable final String customerName) {
        final Long cartId = cartService.addCart(productRequest.getId(), customerName);
