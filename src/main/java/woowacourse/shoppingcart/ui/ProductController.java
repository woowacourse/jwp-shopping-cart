...
public class ProductController {
    ...
    @PostMapping
    public ResponseEntity<Void> add(@RequestBody final ProductSaveRequest productSaveRequest) {
        final Long productId = productService.addProduct(productSaveRequest);
