...
public class ControllerAdvice {
    @ExceptionHandler({LoginFailureException.class, TokenInvalidException.class})
    public ResponseEntity<ExceptionResponse> handleLoginFailureException(RuntimeException e) {
