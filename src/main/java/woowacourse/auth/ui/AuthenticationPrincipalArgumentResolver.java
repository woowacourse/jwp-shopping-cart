...
public class AuthenticationPrincipalArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    @Override
    public CustomerRequest resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer,
        ...
        return objectMapper.readValue(jwtTokenProvider.getPayload(accessToken), CustomerRequest.class);
    }
}
