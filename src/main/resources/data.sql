...
values ('email1@email.com', '12345678');
INSERT INTO users (email, password)
values ('email2@email.com', '12345678');

INSERT INTO items (name, image_url, price)
values ('위키드', 'https://image.yes24.com/themusical/upFiles/Themusical/Play/post_2013wicked.jpg', 150000);
INSERT INTO items (name, image_url, price)
