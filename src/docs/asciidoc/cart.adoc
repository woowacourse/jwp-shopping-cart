...
[[resources-cart-delete-cart-item]]
=== 장바구니에 들어있는 상품 삭제
...
[[resources-cart-delete-cart-item-success]]
==== 성공
...
[[resources-cart-delete-cart-item-not-exist-item]]
==== 실패 - 존재하지 않는 상품
...
[[resources-cart-change-quantity]]
=== 장바구니에 들어있는 상품 수량 변경
...
[[resources-cart-change-quantity-success]]
==== 성공
...
[[resources-cart-change-quantity-invalid-quantity]]
==== 실패 - 잘못된 수량으로 요청한 경우
...
[[resources-cart-change-quantity-not-exist-product]]
